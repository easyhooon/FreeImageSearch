...
import com.kenshi.freeimagesearch.databinding.ItemPhotoBinding
...
class PhotoAdapter: RecyclerView.Adapter<PhotoAdapter.ViewHolder>() {
    ...
    //inner 가 존재해야 상위 클래스에서 정의한 onClickPhoto 에 접근 가능해짐
    inner class ViewHolder(
        ...
        fun bind(photo: PhotoResponse) {
            ...
            var targetWidth = binding.root.resources.displayMetrics.widthPixels -
            ...
            Glide.with(binding.root)
                ...
                .circleCrop()
                    //placeholder 가 먼저 보였다가 로딩이 끝나고 프로필사진이 선명히 보이도록
                .transition(DrawableTransitionOptions.withCrossFade())
